...
function showPop(i) {
  console.log('ðŸ”” showPop invocado para', i.id);
...
document.querySelectorAll('.filter-btn').forEach(btn => {
  btn.addEventListener('click', () => {
    ...
    filterBy(cat);
    bottomSheet.classList.remove('open');  // cierra el panel en mÃ³vil si estÃ¡ abierto
  });
});
...
(function(){
  ...
  // 4) Pinturas: â€œAnterioresâ€ muestra todo; 2025 oculta
...
(function(){
  ...
  function ensureCaption(img){
    ...
    const short = desc.length > 220 ? (desc.slice(0,217)+'â€¦') : desc;
  ...
  document.addEventListener('DOMContentLoaded',()=>{
    ...
    // MÃ³vil: tap para ver/ocultar etiqueta sin popup
